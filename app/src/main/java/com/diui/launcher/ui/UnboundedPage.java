...
public class UnboundedPage {
    ...
    private com.diui.launcher.api.BydAcApi acApi;
    private com.diui.launcher.model.VehicleStatus lastStatus;
    ...
    public void setAcApi(com.diui.launcher.api.BydAcApi acApi) {
        this.acApi = acApi;
    }
